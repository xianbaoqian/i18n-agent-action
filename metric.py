...
LLM_RESPONSE_TIME = Summary('llm_response_time_seconds', 'Time spent processing LLM requests')
LLM_TOKENS_USED = Counter('llm_tokens_used_total', 'Total tokens used by LLM', ['model', 'type'])
# 定义指标
