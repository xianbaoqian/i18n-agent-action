...
def sample_data():
    ...
    return {
        ...
        "data": {
            "key1": {"value": "value1", "timestamp": current_time - 86400, "_type": "string"},
            "key2": {"value": "value2", "timestamp": current_time - 43200, "_type": "string"},  # 半天前
            "expired_key": {"value": "expired_value", "timestamp": current_time - 8*86400, "_type": "string"}  # 8天前
        }
    }
